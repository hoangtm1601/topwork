<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
    <div class="form-group">
        {!! Html::decode(Form::label('name', __('Category Name') . '<span class="red">*</span>', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12'])) !!}
...
<div class="form-group {{ $errors->has('') ? 'has-error' : '' }}">
    <div class="form-group">
        {!! Html::decode(Form::label('parent_id', __('Parent Category') . '<span class="red">*</span>', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12'])) !!}
        <div class="col-md-12 col-sm-6 col-xs-12">
            {!! Form::select('parent_id', $categories, isset($category->parent_id) ? $category->parent_id : 0,['class' => 'form-control']) !!}
